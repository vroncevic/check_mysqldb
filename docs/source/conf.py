...
Copyright
    ...
    check_mysqldb is distributed in the hope that it will be useful, but
...
project: str = 'check_mysqldb'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '2.0'
release: str = 'https://github.com/vroncevic/check_mysqldb/releases'
...
htmlhelp_basename: str = 'check_mysqldbdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'check_mysqldb.tex', 'check_mysqldb Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'check_mysqldb', 'check_mysqldb Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'check_mysqldb', 'check_mysqldb Documentation', author,
